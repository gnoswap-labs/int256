...
func TestOr(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if *res != tt.want {
				t.Errorf("Or(%s, %s) = %s, want %s", tt.x.ToString(), tt.y.ToString(), res.ToString(), (tt.want).ToString())
			}
		})
	}
}
...
func TestAnd(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if *res != tt.want {
				t.Errorf("And(%s, %s) = %s, want %s", tt.x.ToString(), tt.y.ToString(), res.ToString(), (tt.want).ToString())
			}
		})
	}
}
...
func TestNot(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if *res != tt.want {
				t.Errorf("Not(%s) = %s, want %s", tt.x.ToString(), res.ToString(), (tt.want).ToString())
			}
		})
	}
}
...
func TestAndNot(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if *res != tt.want {
				t.Errorf("AndNot(%s, %s) = %s, want %s", tt.x.ToString(), tt.y.ToString(), res.ToString(), (tt.want).ToString())
			}
		})
	}
}
...
func TestXor(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if *res != tt.want {
				t.Errorf("Xor(%s, %s) = %s, want %s", tt.x.ToString(), tt.y.ToString(), res.ToString(), (tt.want).ToString())
			}
		})
	}
}
